...
//the UserID aka DonorID of the user generating this report
$donorId = 4;
$lastTaxGen = '2016-12-30 21:00:00';
...
$sql = "SELECT * FROM IncDonationTable WHERE DonorID='".$donorId.
...
//TODO make this message pretty
 echo "Thank you for your donation. Your tax receipet document has been sent to your registered email account."

//TODO
//get user id dynamically
//update time stamp of last tax generated field
//add a last tax generated field to the db table
//error message if no there are no items donated since last tax receipt generated
